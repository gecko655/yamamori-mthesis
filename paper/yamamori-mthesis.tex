...
1つ目はMylynを拡張し、既存研究の変更推薦手法で必要な情報をMylynの操作履歴出力ファイルに含める方法であり、これにより十分な検証を行なうことが難しかった既存研究の問題を解決する。
2つ目は現バージョンのMylynが出力する7年分かつ実開発で記録された操作履歴を利用して新たな変更推薦手法を提案する。
