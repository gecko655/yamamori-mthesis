...
$x_1$と$x_2$はそれぞれ、「左辺値」、「右辺値」と呼ばれている。
...
本稿ではこのLCExtractorを拡張し、変更履歴や参照履歴を入力することで、共変更の相関ルール(co-change association rules)と共参照の相関ルール(co-reference association rules)が計算できるようにした。
